function initRankings(){
  ...
  var chart = function() {
    ...
    var pillTypes = [
      ...
      {func:oneColor, opts: {colors:["#767676"]}, id:"ERI", name:"Eritrea"},
      ...
      {func:oneColor, opts: {colors:["#767676"]}, id:"NGA", name:"Nigeria"},
      {func:oneColor, opts: {colors:["#4bc6df"]}, id:"RUS", name:"Russia"},
      {func:oneColor, opts: {colors:["#4bc6df"]}, id:"ALB", name:"Albania"},
      {func:oneColor, opts: {colors:["#767676"]}, id:"SOM", name:"Somalia"},
      {func:oneColor, opts: {colors:["#767676"]}, id:"STL", name:"Stateless"},
      {func:oneColor, opts: {colors:["#4bc6df"]}, id:"UKR", name:"Ukraine"},
      {func:oneColor, opts: {colors:["#767676"]}, id:"MLI", name:"Mali"},
      {func:oneColor, opts: {colors:["#ff9b0b"]}, id:"BGD", name:"Bangladesh"},
      {func:oneColor, opts: {colors:["#767676"]}, id:"GMB", name:"Gambia"},
      ...
      {func:oneColor, opts: {colors:["#ff9b0b"]}, id:"LKA", name:"Sri Lanka"},
      {func:oneColor, opts: {colors:["#4bc6df"]}, id:"ROU", name:"Romania"},
      {func:oneColor, opts: {colors:["#767676"]}, id:"DZA", name:"Algeria"},
      {func:oneColor, opts: {colors:["#767676"]}, id:"UNK", name:"Unknown"},
      {func:oneColor, opts: {colors:["#ff9b0b"]}, id:"ARM", name:"Armenia"},
      {func:oneColor, opts: {colors:["#ff9b0b"]}, id:"IND", name:"India"},
      {func:oneColor, opts: {colors:["#767676"]}, id:"SLE", name:"Sierra Leone"},
      {func:oneColor, opts: {colors:["#ff9b0b"]}, id:"VNM", name:"Vietnam"},
      {func:oneColor, opts: {colors:["#767676"]}, id:"SDN", name:"Sudan"},
      {func:oneColor, opts: {colors:["#951c55"]}, id:"COL", name:"Colombia"},
      {func:oneColor, opts: {colors:["#ff9b0b"]}, id:"AZE", name:"Azerbaijan"},
      {func:oneColor, opts: {colors:["#767676"]}, id:"AGO", name:"Angola"},
      ...
      {func:oneColor, opts: {colors:["#767676"]}, id:"COD", name:"Congo DR"},
      {func:oneColor, opts: {colors:["#ff9b0b"]}, id:"CHN", name:"China"},
      {func:oneColor, opts: {colors:["#4bc6df"]}, id:"MNE", name:"Montenegro"},
      {func:oneColor, opts: {colors:["#767676"]}, id:"ZWE", name:"Zimbabwe"}
